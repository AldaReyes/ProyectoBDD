...
class appWindow(QWidget):#Clase Que Hereda QWidget
    ...
    def contenido(self):
        ...
        for nombreBoton_1_1, colorPanel_1_1 in zip(self.nombreBotones_1_1,self.coloresBotones_1_1):#Ciclo Para Emparejar Listas
            self.paneles_1_1 = QFrame(self.panelesGuardados_1[1])#Añadir En Panel 1 
        ...
        self.comboBoxPanel_1 = QComboBox(self.panelesGuardados_1[1])#Añadir En Panel 1_1
        self.comboBoxPanel_1.addItems(self.nombreBotones_1_1)#Añadir Items De Lista
        self.comboBoxPanel_1.move(20, 40)#Posicion De ComboBox
        self.comboBoxPanel_1.setFixedSize(80, 20)#Definir Tamaño
        self.comboBoxPanel_1.currentIndexChanged.connect(self.selectPaneles2)#Cuando Cambie De Opcion Cambia De Pestaña
