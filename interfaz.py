...
class Interfaz():
    def panelSeleccionado(self, indice):
        ...
        if indice < 4:
            ...
            if indice == 0:
                ...
                self.textoPanel1 += 'Modificar'
            elif indice == 2:
                self.textoPanel1 += 'Borrar'
            elif indice == 3:
                self.textoPanel1 += 'Consultar'
    ...
    def contenido(self):
        self.paneles1 = []
        self.nombrePanel = ['Insertar', 'Modificar', 'Borrar', 'Consultar']
        ...
        self.nombreBotones = ['Insertar', 'Modificar', 'Borrar','Consultar','Salir']
